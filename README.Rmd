...
<!-- badges: start -->
[![GitHub last commit](https://img.shields.io/github/last-commit/a-maldet/composerr.svg?logo=github)](https://github.com/a-maldet/composerr/commits/master)
[![GitHub code size in bytes](https://img.shields.io/github/languages/code-size/a-maldet/composerr.svg?logo=github)](https://github.com/a-maldet/composerr)
<!-- badges: end -->
...
This R package offers easy to use functions that help
implementing a professional error handling, which is maintainable.
